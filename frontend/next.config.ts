...
const securityHeaders = [
  ...
  // The Irys gateway is allowlisted for image/script fetches.
  {
    ...
    value: [
      ...
      "connect-src 'self' https://api.mainnet-beta.solana.com https://*.helius-rpc.com https://gateway.irys.xyz https://dweb.link https://arweave.net https://s3.tradingview.com https://*.tradingview.com wss://*.tradingview.com",
